function dashboard(id, fData){
    ...
    function segColor(c){ return {Cadre:"#003F57", Intermédiaire:"#96D0DE", Employé:"#41ab5d", Recherche:"#E34824", Inactif :"#BDD02B"}[c]; }
    
    // compute total for each state.
    fData.forEach(function(d){d.total=d.freq.Cadre+d.freq.Intermédiaire+d.freq.Employé+d.freq.Recherche+d.freq.Inactif;});
    ...
    var tF = ['Cadre','Intermédiaire','Employé', 'Recherche', 'Inactif'].map(function(d){ 
