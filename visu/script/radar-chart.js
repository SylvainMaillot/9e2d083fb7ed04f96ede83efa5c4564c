  ...
  d3.csv("visu/data/insertion.csv", function(error,data){
    ...
    data.forEach(function (d){
      if(d.id == id){
            ...
            region = parseFloat(d.emploi_region);
      ...
      if(age){
          var data = [
            {
              className: 'select', // optional, can be used for styling
              axes: [
            ...
            {
              className: 'mean', // optional, can be used for styling
              axes: [
                {axis: "Âge moyen", value: (mage/maxage*100).toFixed(2)},
                {axis: "Revenu", value: (mrevenu/maxrevenu*100).toFixed(2)},
                {axis: "Adéquation entre étude et emploi", value: (mnote/maxnote*100).toFixed(2)},  
                {axis: "Emplois dans la région", value: (mregion/maxregion*100).toFixed(2)},  
                {axis: "En Emploi", value: (memplois/maxemplois*100).toFixed(2)}
              ]
            }
          ]
